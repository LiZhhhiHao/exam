...
const state = {
  ...
  menu: [{
      ...
      content:[{item2:'考试查询',path:'selectExam'}],
    },
    {
      index: '2',
      title: '题库管理',
      icon: 'icon-tiku',
      content:[{path:'/answerDescription'},{item2:'所有题库',path:'/selectAnswer'},{item3:'增加题库',path:'/addAnswer'},{path: '/addAnswerChildren'}],
    },
    {
      index: '3',
      title: '成绩查询',
    ...
    },
    {
      ...
      title: '学生管理',
      icon: 'icon-role',
      content:[{item1:'学生管理',path:'/studentManage'}],
    },
    // {
    //   index: '5',
    //   title: '教师管理',
